...
const struct SpeciesInfo gSpeciesInfoGen1[] =
{
    ...
    [SPECIES_CATERPIE] =
    {
        ...
        .abilities = { ABILITY_RUN_AWAY, ABILITY_NONE, ABILITY_TINTED_LENS },
    ...
    [SPECIES_WEEDLE] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_POISON_TOUCH, ABILITY_NONE, ABILITY_RUN_AWAY },
        .innates = { ABILITY_SHIELD_DUST },
...
#define BEEDRILL_ATTACK (P_UPDATED_STATS >= GEN_6 ? 90 : 80)
    ...
    [SPECIES_PIDGEY] =
    {
        ...
        .abilities = { ABILITY_NO_GUARD, ABILITY_NONE, ABILITY_GALE_WINGS },
...
#define PIDGEOT_SPEED (P_UPDATED_STATS >= GEN_6 ? 101 : 91)
    ...
    #endif
        // = { ABILITY_VITAL_SPIRIT, ABILITY_TOUGH_CLAWS, ABILITY_QUICK_DRAW },
		.bodyColor = BODY_COLOR_BROWN,
